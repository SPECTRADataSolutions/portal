...
Sign In
</a> </li>`} </ul> </nav> </div> </header> <!-- Main Content Blocks --> <main data-astro-cid-j7pv25f6> <!-- Hero Section --> <section class="bg-spectra-dark text-spectra-cloud py-20 px-6 text-center" data-astro-cid-j7pv25f6> <img src="https://github.com/SPECTRADataSolutions/framework/blob/main/assets/images/spectraLogo.png?raw=true" alt="SPECTRA Logo" class="mx-auto mb-4 h-20" data-astro-cid-j7pv25f6> <h1 class="text-6xl font-bold tracking-tight" style="font-family: 'Poppins', sans-serif;" data-astro-cid-j7pv25f6>
SPECTRA
</h1> <p class="text-xl mt-4" data-astro-cid-j7pv25f6>
Modular AI-powered data pipelines for Microsoft Fabric
</p> </section> <!-- About SPECTRA --> <section id="about" class="py-20 px-6 bg-spectra-smoke" data-astro-cid-j7pv25f6> <div class="max-w-4xl mx-auto text-center" data-astro-cid-j7pv25f6> <h2 class="text-3xl font-bold text-spectra-blue mb-6" data-astro-cid-j7pv25f6>About SPECTRA</h2> <div class="text-lg text-spectra-ink leading-relaxed space-y-4" data-astro-cid-j7pv25f6> <p data-astro-cid-j7pv25f6>
...
Our goal is to eliminate the complexity and cost barriers that have
          traditionally prevented businesses from harnessing the full potential
          of their data. By providing intelligent, automated data pipelines that
          integrate seamlessly with Microsoft Fabric, we're empowering
          organizations to focus on insights rather than infrastructure.
</p> <p data-astro-cid-j7pv25f6> <strong data-astro-cid-j7pv25f6>For small businesses:</strong> We offer affordable, plug-and-play
          solutions that provide enterprise-level data capabilities without the enterprise-level
          complexity or cost. Get started quickly with pre-built connectors and automated
          ...
          governance requirements, and enterprise-grade security while reducing operational
...
Trusted by
</p> <div class="flex justify-center gap-12 grayscale opacity-80" data-astro-cid-j7pv25f6> <img src="/logos/dxc.svg" alt="DXC" class="h-10" data-astro-cid-j7pv25f6> <img src="/logos/velonetic.svg" alt="Velonetic" class="h-10" data-astro-cid-j7pv25f6> <img src="/logos/lloyds.svg" alt="Lloyds of London" class="h-10" data-astro-cid-j7pv25f6> </div> </section> <!-- What We Do --> <section id="what-we-do" class="py-20 px-6 bg-spectra-cloud" data-astro-cid-j7pv25f6> <div class="max-w-5xl mx-auto text-center" data-astro-cid-j7pv25f6> <h2 class="text-3xl font-bold text-spectra-blue mb-4" data-astro-cid-j7pv25f6>What We Do</h2> <p class="text-lg text-spectra-ink mb-8" data-astro-cid-j7pv25f6>
The SPECTRA Engine is designed to automate every stage of your data
        lifecycle.
</p> <div class="flex flex-wrap justify-center gap-4 text-left" data-astro-cid-j7pv25f6> <!-- ... all your stage cards ... --> <!-- Unchanged from your input --> <div class="bg-white p-2 rounded shadow w-40" data-astro-cid-j7pv25f6> <h3 class="font-bold text-spectra-blue text-sm" data-astro-cid-j7pv25f6>Source</h3> <p class="text-xs mt-1" data-astro-cid-j7pv25f6>
Secure connection to any API, app or source system.
</p> </div> <!-- etc ... --> </div> </div> </section> <!-- Framework --> <section id="framework" class="py-20 px-6 bg-spectra-smoke" data-astro-cid-j7pv25f6> <div class="max-w-5xl mx-auto text-center" data-astro-cid-j7pv25f6> <h2 class="text-3xl font-bold text-spectra-blue mb-4" data-astro-cid-j7pv25f6>Framework</h2> <p class="text-lg text-spectra-ink mb-8" data-astro-cid-j7pv25f6>
Our modular framework provides the foundation for scalable data
        solutions.
</p> <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6 text-left" data-astro-cid-j7pv25f6> <!-- ... all your framework cards ... --> <!-- Unchanged from your input --> <div class="bg-white p-6 rounded-lg shadow-md" data-astro-cid-j7pv25f6> <h3 class="font-bold text-spectra-blue text-lg mb-3" data-astro-cid-j7pv25f6>
Modular Architecture
</h3> <p class="text-sm text-spectra-ink" data-astro-cid-j7pv25f6>
Built with microservices architecture enabling flexible deployment
            and scaling of individual components.
</p> </div> <!-- etc ... --> </div> </div> </section> <!-- Explore More --> <section class="py-20 px-6 text-center" data-astro-cid-j7pv25f6> <h2 class="text-3xl font-bold text-spectra-blue mb-4" data-astro-cid-j7pv25f6>Explore More</h2> <div class="flex justify-center gap-6" data-astro-cid-j7pv25f6> <a href="/vision" class="px-6 py-3 bg-spectra-blue text-white rounded-lg shadow-md hover:bg-spectra-orange transition" data-astro-cid-j7pv25f6>Our Vision</a> <a href="/strategic-plan" class="px-6 py-3 bg-spectra-blue text-white rounded-lg shadow-md hover:bg-spectra-orange transition" data-astro-cid-j7pv25f6>Strategic Plan</a> </div> </section> <!-- Contact --> <section id="contact" class="py-20 px-6 bg-spectra-cloud" data-astro-cid-j7pv25f6> <div class="max-w-4xl mx-auto text-center" data-astro-cid-j7pv25f6> <h2 class="text-3xl font-bold text-spectra-blue mb-6" data-astro-cid-j7pv25f6>Contact Us</h2> <p class="text-lg text-spectra-ink mb-8" data-astro-cid-j7pv25f6>
...
Schedule a consultation to discuss your data needs and explore how
            SPECTRA can help.
...
Explore our comprehensive documentation and resources to understand
            our solutions.
...
</a>`} </section> </main> ${renderScript($$result, "/home/runner/work/portal/portal/src/pages/index.astro?astro&type=script&index=0&lang.ts")}`;
