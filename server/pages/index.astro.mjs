/* empty css                                 */
import { e as createComponent, f as createAstro, k as renderHead, n as renderComponent, r as renderTemplate, h as addAttribute, o as Fragment } from '../chunks/astro/server_C7ncb0ib.mjs';
import 'kleur/colors';
...
The SPECTRA Engine
</h2> <p class="text-lg text-spectra-ink mb-8">
Designed to automate every stage of your data lifecycle.
</p> <div class="flex flex-wrap justify-center gap-4 text-left"> <div class="bg-white p-2 rounded shadow w-40"> <h3 class="font-bold text-spectra-blue text-sm">Source</h3> <p class="text-xs mt-1">
Secure connection to any API, app or source system.
</p> </div> <div class="bg-white p-2 rounded shadow w-40"> <h3 class="font-bold text-spectra-blue text-sm">Prepare</h3> <p class="text-xs mt-1">
Ingest, checkpoint and validate control tables.
</p> </div> <div class="bg-white p-2 rounded shadow w-40"> <h3 class="font-bold text-spectra-blue text-sm">Extract</h3> <p class="text-xs mt-1">
Smart extract logic with schema awareness and paging.
</p> </div> <div class="bg-white p-2 rounded shadow w-40"> <h3 class="font-bold text-spectra-blue text-sm">Clean</h3> <p class="text-xs mt-1">
Flatten, restructure, rename and timestamp.
</p> </div> <div class="bg-white p-2 rounded shadow w-40"> <h3 class="font-bold text-spectra-blue text-sm">Transform</h3> <p class="text-xs mt-1">
Model-ready formats for semantic layers and BI tooling.
</p> </div> <div class="bg-white p-2 rounded shadow w-40"> <h3 class="font-bold text-spectra-blue text-sm">Refine</h3> <p class="text-xs mt-1">
Optimise for cost, scale, performance and storage class.
</p> </div> <div class="bg-white p-2 rounded shadow w-40"> <h3 class="font-bold text-spectra-blue text-sm">Analyse</h3> <p class="text-xs mt-1">
